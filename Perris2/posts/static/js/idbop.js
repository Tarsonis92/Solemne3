var dbPromise = idb.open('posts.Mascota', 5, function(upgradeDb) {
	upgradeDb.createObjectStore('Mascota',{keyPath:'pk'});
});
	...
	var post="";
	dbPromise.then(function(db){
		var tx = db.transaction('Mascota', 'readonly');
  		var feedsStore = tx.objectStore('Mascota');
